      ...
      <div class="card mb-4">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold mb-2">Status Berat Badan Bulan Ini</p>
                @if ($weightStatus)
                    <h5 class="font-weight-bolder mb-3 text-{{ $weightStatusColor }}">
                        {{ $weightStatus }}
                    </h5>
                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="/kartu-posyandu">
                        Kartu Posyandu
                        <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
                    </a>
                @else
                    <p class="mb-3 text-sm text-danger">Kamu belum mengisi data posyandu bulan ini, silahkan isi terlebih dahulu!</p>
                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="/kartu-posyandu">
                        Kartu Posyandu
                        <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
                    </a>
    ...
    //   });
        ...
        new Chart(ctx2, {
            ...
            datasets: [{
                ...
                backgroundColor: gradientStroke2,
                fill: true,
                data: items.map((item) => item.weight / ((item.height / 100) * (item.height / 100))),
                maxBarThickness: 6
                },
            ],
            },
